...
% Stacked co-occurrence visualizations (vertical)
\begin{figure}[ht]
  \centering
  \includegraphics[width=1\linewidth,height=0.35\textheight,keepaspectratio]{images/data_description/CC_narratives_conditional_probability.png}
  \par\medskip\centering\footnotesize (a) CC narratives heatmap\par\medskip
  \includegraphics[width=1\linewidth,height=0.35\textheight,keepaspectratio]{images/data_description/URW_narrative_conditional_probability.png}
  \par\medskip\centering\footnotesize (b) URW narratives conditional graph\par
  \caption{Co-occurrence / conditional-probability visualizations for the most frequent narrative groups. Top: heatmap for CC narratives (normalized cell values). Bottom: conditional-probability visualization for URW narratives (directional). These paired views help identify both symmetric and directional dependencies among narratives.}
